...
class CoupletGenerator(QWidget):
    def __init__(self, parent=None, **kwargs):
        ...
        # 初始化, 相关key需要在https://console.bce.baidu.com/#/index/overview申请
        self.setWindowTitle('对联生成器 —— Charles的皮卡丘')
        ...
        self.api_key = '需自己申请: https://console.bce.baidu.com/#/index/overview'
        self.secret_key = '需自己申请: https://console.bce.baidu.com/#/index/overview'
