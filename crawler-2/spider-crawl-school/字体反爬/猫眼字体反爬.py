...
class MYSpider(object):
    ...
    def __init__(self):
        ...
        self.base_num_glyph_map = {
            0: base_glyph["glyph00000"],
            1: base_glyph["x"],
            2: base_glyph["uniE0C1"],
            3: base_glyph["uniEC15"],
            4: base_glyph["uniEE88"],
            5: base_glyph["uniE35D"],
            6: base_glyph["uniE626"],
            7: base_glyph["uniF2EB"],
            8: base_glyph["uniE2D2"],
            9: base_glyph["uniE2D2"],
        }
    ...
    def font_map(self):
        """对字体生成新的映射"""
        # 生成当前字体文件的对象
        font = TTFont('maoyan_new.woff')
        font.saveXML('maoyan_new.xml')  # 将ttf文件生成xml文件并保存到本地
        # 获取当前字体的code和name映射
